...
/** This interface defines a complete listener for a parse tree produced by {@link HplsqlParser}. */
public interface HplsqlListener extends ParseTreeListener {
     ...
     * @param ctx the parse tree
     */
    void enterCreate_table_column_inline_cons(
     ...
     * @param ctx the parse tree
     */
    void exitCreate_table_column_inline_cons(
            HplsqlParser.Create_table_column_inline_consContext ctx);
    /**
     ...
     * @param ctx the parse tree
     */
    void enterCreate_table_preoptions_td_item(
     ...
     * @param ctx the parse tree
     */
    void exitCreate_table_preoptions_td_item(
            HplsqlParser.Create_table_preoptions_td_itemContext ctx);
    /**
     ...
     * @param ctx the parse tree
     */
    void enterCreate_table_options_hive_item(
     ...
     * @param ctx the parse tree
     */
    void enterCreate_table_hive_row_format_fields(
     ...
     * @param ctx the parse tree
     */
    void exitCreate_table_hive_row_format_fields(
            HplsqlParser.Create_table_hive_row_format_fieldsContext ctx);
    /**
     ...
     * @param ctx the parse tree
     */
    void enterCreate_table_options_mssql_item(
     ...
     * @param ctx the parse tree
     */
    void exitCreate_table_options_mssql_item(
            HplsqlParser.Create_table_options_mssql_itemContext ctx);
    /**
     ...
     * @param ctx the parse tree
     */
    void enterCreate_table_options_mysql_item(
     ...
     * @param ctx the parse tree
     */
    void exitCreate_table_options_mysql_item(
            HplsqlParser.Create_table_options_mysql_itemContext ctx);
    /**
     ...
     * @param ctx the parse tree
     */
    void enterAlter_table_add_constraint_item(
     ...
     * @param ctx the parse tree
     */
    void exitAlter_table_add_constraint_item(
            HplsqlParser.Alter_table_add_constraint_itemContext ctx);
    /**
    ...
    /**
     * Enter a parse tree produced by the {@code single_quotedString} labeled alternative in {@link
     * HplsqlParser#string}.
     *
     * @param ctx the parse tree
     */
    ...
    /**
     * Exit a parse tree produced by the {@code single_quotedString} labeled alternative in {@link
     * HplsqlParser#string}.
     *
     * @param ctx the parse tree
     */
    ...
    /**
     * Enter a parse tree produced by the {@code double_quotedString} labeled alternative in {@link
     * HplsqlParser#string}.
     *
     * @param ctx the parse tree
     */
    ...
    /**
     * Exit a parse tree produced by the {@code double_quotedString} labeled alternative in {@link
     * HplsqlParser#string}.
     *
     * @param ctx the parse tree
     */
