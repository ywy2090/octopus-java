...
public interface HplsqlVisitor<T> extends ParseTreeVisitor<T> {
     ...
     * @return the visitor result
     */
    T visitCreate_table_hive_row_format_fields(
    ...
    /**
     * Visit a parse tree produced by the {@code single_quotedString} labeled alternative in {@link
     * HplsqlParser#string}.
     *
     * @param ctx the parse tree
     * @return the visitor result
    ...
    /**
     * Visit a parse tree produced by the {@code double_quotedString} labeled alternative in {@link
     * HplsqlParser#string}.
     *
     * @param ctx the parse tree
     * @return the visitor result
