...
/** */
public class MysqlInsertStatement extends MySqlASTVisitorAdapter {

    private static final Logger logger = LoggerFactory.getLogger(MysqlInsertStatement.class);
    ...
    public static void main(String[] args) {
        ...
        MysqlInsertStatement visitor = new MysqlInsertStatement();
