...
public class Main {
    ...
    public static void main(String[] args) throws JSQLParserException {
        ...
        // finnal String dbType = JdbcConstants.ORACLE; //
        // JdbcConstants.MYSQL或者JdbcConstants.POSTGRESQL
        String sql0 = "select * from mytable a where a.id = 3";
        String sql1 = "select ((0='x6') & 31) ^ (ROW(76, 4) NOT IN (ROW(1, 2 ),ROW(3, 4)) )";
        String sql2 = "update tab01 set d='d1' where a=1 and b='b1'";
        String sql3 =
        ...
        List<SQLStatement> sqlStatements = SQLUtils.parseStatements(sql4, dbType);
        ...
        SQLStatement stmt = SQLUtils.parseSingleMysqlStatement(sql2);
        List<Object> outParameters = new ArrayList<>();
        MySqlParameterizedVisitor visitor1 = new MySqlParameterizedVisitor(outParameters);
