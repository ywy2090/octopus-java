...
CREATE TABLE IF NOT EXISTS `t_user_binary` (
  `user_name` varchar(256) NOT NULL,
  `phone_number` char(11) NOT NULL,
  `id_number` char(18) NOT NULL,
  `encrypted_user_name` VARBINARY(1000) NOT NULL DEFAULT '',
  `encrypted_phone_number` VARBINARY(1000) NOT NULL DEFAULT '',
  `encrypted_id_number`VARBINARY(1000) NOT NULL DEFAULT '',
  PRIMARY KEY (`id_number`),
  INDEX user_name (`user_name`),
  INDEX phone_number (`phone_number`),
  INDEX encrypted_user_name (`encrypted_user_name`),
